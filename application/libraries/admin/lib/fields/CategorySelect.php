...
class CategorySelect extends DatabaseSelect{
	...
	function __construct($content_type, $label = null, $helptext = '', $defaultValue = '')
	{
		parent::__construct($content_type,null,false,$label,$helptext,$defaultValue);
	}
	...
	{	
		...
		$arrList = $ci->db->get( $this->content_type->table )->result_array();
		$arrListIds = array();
