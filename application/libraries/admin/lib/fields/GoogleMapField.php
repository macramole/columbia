...
class GoogleMapField extends Field {
	 ...
	 * 
	 * @param string $label
	 * @param Object $zonaObj El content_type de zona ej. Ciudad
	 * @param Object $subZonaObj El content_type de subzona ej. Barrio
	...
	function render()
	{
		...
		$ci->load->view('admin/fields/googlemapfield.php', $data);
	}
