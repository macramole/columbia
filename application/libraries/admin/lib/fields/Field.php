...
abstract class Field {
	/**
	 * contentTypeName es el nombre del ContentType, para algunos fields se necesita, en particular para los que tienen ajaxCallbacks
	 * Name es el nombre en la base
	 * Label es lo que se muestra el usuario
	 */
	public $contentTypeName, $name, $label, $value, $helptext, $cssId;
	...
	/**
	 * Esta función es llamada desde el content type para establecer su parent y su nombre.
