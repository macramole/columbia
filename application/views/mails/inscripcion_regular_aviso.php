  ...
  <body>
	...
	<div class="info" style="background-color: #f4f4ec;padding: 25px;color: #818086;width: 550px;font-family: Arial, sans-serif;font-size: 13px">
		...
		<p style="margin-top: 0">
			A la siguiente inscripción le quedan <?= $dias ?> dias para vencerse. <br />
			Podés renovar tu inscripción desde tu <a href="http://www.fundacioncolumbia.org">panel de control</a>.
		</p>
