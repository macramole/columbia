				...
				$.ajax({
					...
					success: function (data) {			
						...
						else
						{
							...
							{
								$.ajax({
									url: 'abm/delete/' + ui.draggable.data('type') + '/' + ui.draggable.data('id') + '/true',
									success: function () {			
										//showMessage('Content deleted successfully');
										showMessage('Contenido eliminado');
				...
				$.ajax({
					...
					success: function (data) {			
						...
						else
						{
							...
							{
								$.ajax({
									url: 'abm/delete/' +$('#adminNav').data('type') + '/' + $('#adminNav').data('id') + '/true',
									success: function () {			
										//showMessage('Content deleted successfully');
										showMessage('Contenido eliminado');
										window.location.reload(true);
...
$.widget('ui.magico_sortable', $.ui.sortable, {
	...
	options : {
		...
		start: function (event, ui) {	
				...
				showDroppableZones();
				$('body').trigger('magico-draggable-start');
		},
		stop: function (event, ui) {
			hideDroppableZones();
			$('body').trigger('magico-draggable-stop');
		},
...
$.fn.magico_add_drag = function() {
	$(this).prepend("<img src='images/backend/move_icon_white.gif' class='drag' />");
